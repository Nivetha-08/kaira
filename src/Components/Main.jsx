    ...
    <>
        <div className="main">
          ...
          <div className='p-5 pb-0'>
            ...
            <p className='text-center'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Doloremque quia nulla autem atque reprehenderit excepturi officia aliquid, doloribus ipsa nostrum! Lorem ipsum dolor, sit amet consectetur adipisicing elit. Maxime, est? </p>
          </div>
          ...
          <div className="row">
            ...
            <div className="col-md-4 p-5">
              <div className="card img-container">
                <img src="https://images.unsplash.com/photo-1608015858041-f28d2514e8a8?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Nnx8Z2lybCUyMGltYWdlc3xlbnwwfHwwfHx8MA%3D%3D" className='img-fluid' alt="image1" />
              </div>
              <div className='p-3'>
